        ...
        <Grid
          ...
          <Typography
            ...
            sx={{
              ...
              textAlign: "center",
              mb: 4
            }}>Get to know more about ready-to-use admin dashboard templates</Typography>
            ...
            >
              <Typography
                ...
                sx={{
                  px: 2,
                  py: 1
                }}>What is an Admin Dashboard?</Typography>
            </AccordionSummary>
            <Divider />
            <AccordionDetails>
              <Typography
            ...
            >
              <Typography
                ...
                sx={{
                  px: 2,
                  py: 1
                }}>What should an admin dashboard template include?</Typography>
            </AccordionSummary>
            <Divider />
            <AccordionDetails>
              <Typography
            ...
            >
              <Typography
                ...
                sx={{
                  px: 2,
                  py: 1
                }}>Why should I buy admin templates from AdminMart?</Typography>
            </AccordionSummary>
            <Divider />
            <AccordionDetails>
              <Typography
            ...
            >
              <Typography
                ...
                sx={{
                  px: 2,
                  py: 1
                }}>Do Adminmart offers a money back guarantee?</Typography>
            </AccordionSummary>
            <Divider />
            <AccordionDetails>
              <Typography
