                            ...
                            <Stack
                                ...
                                <Typography
                                    ...
                                    sx={{
                                        fontSize: "40px",
                                        fontWeight: 700
                                    }}>${license.price}</Typography>
                                <Typography variant='body2' sx={{
                                    fontSize: "14px"
                                }}>/ one time pay</Typography>
                            </Stack>
                            <Stack
                                sx={{
                                    my: 4,
                                    ...
                                    <Typography
                                        ...
                                        <Box
                                            ...
                                            sx={{
                                                fontWeight: 700,
                                                whiteSpace: "nowrap"
                                            }}> {license.isSingleProject ? "One" : "Unlimited"} </Box>
                                        Project
                                    </Typography>
                                </Box>
                                <Box
                                    ...
                                    <Typography
                                        ...
                                        sx={{
                                            fontWeight: 700,
                                            whiteSpace: "nowrap"
                                        }}>One Year</Box> Technical Support</Typography>
                                </Box>
                                <Box
                                    sx={{
                                        display: "flex",
                                    ...
                                    <Typography
                                        ...
                                        sx={{
                                            fontWeight: 700,
                                            whiteSpace: "nowrap"
                                        }}>One Year</Box> Free Updates</Typography>
                                </Box>
                            </Stack>
